<template>
  <div>
    ...
    <CRow>
      <CCol class="mx-0">
        <CCard class="border-0 mb-3 mini-card">
          <CCardBody>
            <CRow>
              ...
              <CRow class="px-4 py-3 w-100">
                  ...
                  <CRow>
                    ...
                    <CCol class="d-flex align-items-center ml-3">
                      <div style="margin-top: 5px">
                        <h4 style="line-height: 0.5" class="text-success">
                          1000
                        </h4>
                        <span class="font-small bold"
                          >Pendaftar Terverifikasi</span
                        >
                      </div>
                    </CCol>
                  </CRow>
                ...
                <CCol lg="6">
                  <CRow>
                    ...
                    <CCol class="d-flex align-items-center ml-3">
                      <div style="margin-top: 5px">
                        <h4 style="line-height: 0.5" class="text-warning">
                          1000
                        </h4>
              ...
              <CRow class="px-4 py-3 w-100">
                <CCol lg="6">
                  <CRow>
                    ...
                    <CCol class="d-flex align-items-center ml-3">
                      <div style="margin-top: 5px">
                        <h4 style="line-height: 0.5" class="text-danger">
                          1000
                        </h4>
                        <span class="font-small bold"
                          >Pendaftar Belum Terverifikasi</span
                        >
                      </div>
                    </CCol>
                  </CRow>
                ...
                <CCol lg="6">
                  <CRow>
                    ...
                    <CCol class="d-flex align-items-center ml-3">
                      <div style="margin-top: 5px">
                        <h4 style="line-height: 0.5" class="text-primary">
                          1000
                        </h4>
        ...
        <CRow class="pb-1">
          ...
          <CCol class="d-flex justify-content-end">
            <div class="d-flex mr-3">
              ...
              <CSelect class="w-16" :options="['Semua']" />
            </div>
            <div class="d-flex">
              <label class="align-middle pr-3 py-2">Status</label>
              <CSelect :options="['Semua']" />
            </div>
          </CCol>
        </CRow>
        <CRow>
            ...
            <table class="table table-striped table-borderless font-small">
              <thead class="bg-primary">
                <tr class="text-center">
                  ...
                  <td class="text-left">Hak Pilih</td>
                  <td>Status</td>
                </tr>
              </thead>
              <tbody>
                ...
                >
                  <td>{{ index + 1 }}</td>
                  <td class="text-left">{{ listVoters[index].namaLengkap }}</td>
                  <td class="text-left">{{ listVoters[index].hakPilih }}</td>
                  <td>
                    {{
                      listVoters[index].status === true
                        ? "Verifikasi"
                        : "Belum Verifikasi"
                    }}
                  </td>
        ...
        <CRow class="pb-1">
          ...
          <CCol class="d-flex justify-content-end">
            <div class="d-flex mr-3">
              ...
              <CSelect :options="['Dewan Pengawas Nasional']" />
            </div>
          </CCol>
        </CRow>
        <CRow>
            ...
            <table class="table table-striped table-borderless font-small">
              <thead class="bg-primary">
                <tr class="text-center">
                  ...
                  <td>Foto</td>
                  <td class="text-left">Nama Lengkap</td>
                  <td class="text-left">Status Pencalonan</td>
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    <img
                      :src="peringkatKandidat[index].foto"
                      class="c-avatar-img"
                      alt="img-user"
                    />
                  </td>
                  <td class="text-left">
                    {{ peringkatKandidat[index].namaLengkap }}
                  </td>
                  <td class="text-left">
                    {{ peringkatKandidat[index].statusPencalonan }}
                  </td>
                  <td class="text-left">
                    {{ peringkatKandidat[index].jadwal }}
                  </td>
